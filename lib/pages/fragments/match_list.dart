  ...
  Widget build(BuildContext context) {
    if (this.widget.teamNumber == '0') {
                    ...
                    return new ListTile(
                        ...
                        trailing: Column(
                          children: <Widget>[
                            ...
                            Text(
                              snapshot
                                  .data.documents[index].data['blueAlliance']
                                  .toString()
                                  .replaceAll('[', '')
                                  .replaceAll(']', '')
                                  .replaceAll(',', ''),
                        ...
                        onTap: () {
                          navigateToMatchPage(
                              ...
                              snapshot
                                  .data.documents[index].data['matchNumber']);
                        });
                  },
                );
            }
      ...
      return new Scaffold(
        appBar: AppBar(
          title:
              Text('Team' + this.widget.teamNumber.toString() + ' \'s Matches'),
          actions: <Widget>[
            IconButton(
              icon: Icon(Icons.search),
              onPressed: null,
        ...
        body: StreamBuilder<QuerySnapshot>(
          stream: Firestore.instance
              .collection('matches')
              .where('teamNumber', isEqualTo: this.widget.teamNumber)
              .orderBy('matchNumber')
              .snapshots(),
          builder:
              (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
